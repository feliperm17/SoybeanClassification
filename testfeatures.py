...
dir = './SoybeanSeeds/Immature_teste'
for i in range(1, 51):
    img_path = os.path.join(dir, f'{i}.jpg')
    gray_img = imread(img_path, as_gray=1)
    gray_img_u = img_as_ubyte(gray_img)
...
dir = './SoybeanSeeds/Spotted_teste'
...
df_lbp_hist_b.to_csv('./featuresTeste.csv', index=False)
